...
\section{Requerimientos}
        ...
        \subsection{Descripción detallada}
				...
				\input{requerimientos/R22.tex}
                \pagebreak
                
                \input{requerimientos/R23.tex}
                %%\pagebreak
				
				\input{requerimientos/R24.tex}
                %\%pagebreak
				
				\input{requerimientos/R25.tex}
                %\%pagebreak
				
				\input{requerimientos/R26.tex}
                %\%pagebreak
				
				\input{requerimientos/R27.tex}
                %\%pagebreak
				
				\input{requerimientos/R28.tex}
                \pagebreak
				
				\input{requerimientos/R29.tex}
                %\%pagebreak
				
				\input{requerimientos/R30.tex}
                %\%pagebreak
				...
				\input{requerimientos/R33.tex}
                %\%pagebreak
				
				\input{requerimientos/R34.tex}
                %\%pagebreak
				
				\input{requerimientos/R35.tex}
                %\%pagebreak
				
				\input{requerimientos/R36.tex}
                %\%pagebreak

				\input{requerimientos/R37.tex}
                %\%pagebreak        
				
				\input{requerimientos/R38.tex}
                %\%pagebreak
