...
{El sistema pide los parámetros para generar el reporte, el usuario debe elegir documentos existentes  ordenados por formato, entonces se muestra un cuadro de dialogo pidiendo la dirección donde se guardará el reporte, y otro cuadro de dialogo notificando la entrega del reporte.} \\
\hline
