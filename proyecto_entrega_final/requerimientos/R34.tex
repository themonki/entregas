...
El usuario administrador que esté solicitando el reporte debe de proporcionar el nombre del reporte al momento en que el sistema pide los parámetros para generar el reporte, en este caso el usuario deberá elegir 'documentos catalogados ordenados por fecha'. Además, una vez se haya generado el reporte deberá de proporcionar la dirección donde se guardará el reporte.}\\
\hline
