...
El usuario que este realizando la operación de catalogación debe de proporciona de manera obligatoria los siguientes datos sobre el documento: el título principal, el idioma en el que esta escrito el documento, la descripción del documento, el formato, el enlace  a donde se encuentra actualmente el documento, el o los autores del documento, las palabras clave relacionadas con el documento, la o las áreas de las ciencias de la computación a la que pertenece, los derechos de autor, la editorial, la fecha de publicación y el tipo al que pertenece el documento. Puede proporcionar además el título secundario o traducido, la fecha de creación, el tamaño del archivo en bytes, la resolución en pixeles(si aplica) y el software recomendado para abrir el documento. }\\
\hline
