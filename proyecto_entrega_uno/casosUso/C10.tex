...
\hline
\bf {Nombre del caso de uso:}&\multicolumn{3}{|p{6cm}|}{Generar Reporte de Usuarios} \\
\hline 
...
\hline 
\bf Descripción: &\multicolumn{3}{|p{9cm}|}{  Permite la generación de reportes que tengan que ver con los Usuarios del Sistema} \\
\hline 
